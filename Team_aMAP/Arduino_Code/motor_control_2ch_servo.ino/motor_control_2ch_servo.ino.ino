...
#define NEURAL_ANGLE 90  //서보중립
#define LEFT_STEER_ANGLE 133
#define RIGHT_STEER_ANGLE 47
...
void setup() 
{
  ...
  Steeringservo.write(Steering_Angle); // 중립기어 설정
...
void loop() {
  ...
  sonar_data = sonar_sensor_read() * 10; // cm*10
  if(debug == 1){
    Serial.print("Sonar : ");
...
//    NEURAL_ANGLE 90  //서보중립
//    LEFT_STEER_ANGLE 
//    RIGHT_STEER_ANGLE 

//  int Steering_Angle = NEURAL_ANGLE;
  
//  Steeringservo.write(max_RIGHT_STEER_ANGLE-10);
//  delay(3000);
